  ...
  return (
    <>
      <aside
        ...
        aria-label="Sidebar"
      >
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800 scrollbar-hide">
          <Link to={"/Home"}>
            <a class="flex items-center ps-2.5 mb-5 border-b border-slate-400 pb-7">
              <img
            ...
            {navList.map((items, index) => {
              ...
              return (
                <li key={index}>
                  ...
                  >
                    {icon}
                    <span class="flex-1 ms-3 whitespace-nowrap">{navName}</span>
                    <span class="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 font-medium ">
                      {sidebar === id ? (
                        <svg
                          fill="currentColor"
                          class="flex-shrink-0 w-3 h-3 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 448 512"
                        >
