  ...
  return (
    ...
    "
                ...
                <div class="mb-5">
                  ...
                  <textarea id="message" rows="3" class=" resize-none block p-2.5 w-full text-sm text-gray-900 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 " placeholder="Description....."></textarea>
                </div>
