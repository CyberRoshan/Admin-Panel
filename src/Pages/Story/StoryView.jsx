    ...
    <table className="w-full  text-left rtl:text-right text-gray-500 ">
        ...
        <tbody>
            <tr className="bg-white border-b">
                ...
                <td className="px-6 py-4">
                    <img className='w-16 h-16 rounded-md object-cover' src="https://i.pinimg.com/originals/bf/e0/39/bfe03930f2a1bfff7515a14dc47d34d1.png" alt="" />
                </td>
                <td className="px-6 py-4">
                    <img className='w-32 h-16 shadow-sm rounded-md object-cover' src="https://cdn.dribbble.com/users/9358822/screenshots/17654770/media/55b47027c4011bc8cef2cc1657dcc3ab.jpg?resize=400x0" alt="" />
                </td>
                <td className="px-6 py-4">
                    <p className='line-clamp-1 w-[180px]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Harum ipsa consequatur animi rerum at eveniet praesentium explicabo expedita assumenda voluptas maiores nobis,</p>
